...
from aawiki.views import ResourceListView, ResourceDetailView, AnnotationUpdateView, AnnotationUpdateSuccessView, ResourceDetailAsRDFView
...
urlpatterns = patterns('',
    ...
    url(r'^resources/(?P<pk>\d+)/rdf/$', ResourceDetailAsRDFView.as_view(), name='resource-detail-rdf'),
