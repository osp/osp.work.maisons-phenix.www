...
function tok() {
  switch (token.type) {
    ...
    case 'timecode_start': {
      ...
      begin = 'data-begin="'
        + token.begin.toSeconds() + 's'
        + '"';

      end = token.end ?
        ' data-end="'
        + token.end.toSeconds() + 's'
        + '"' : '';
 ...
 */
String.prototype.toSeconds = String.prototype.toSeconds || function () {
    'use strict';
 ...
 */
String.prototype.secondsTo = String.prototype.secondsTo || function (outputFormat) {
    'use strict';
 ...
 * @return float The value in seconds
 */
Number.prototype.toSeconds = Number.prototype.toSeconds || function () {
    'use strict';
 ...
 * @return string The value in the new format
 */
Number.prototype.secondsTo = Number.prototype.secondsTo || function (outputFormat) {
    'use strict';
